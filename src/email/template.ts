...
export function emailTemplate(email: string, content: string, type: string) {
    ...
    <head>
      ...
      <!-- /////////////////// -->
      <title>${templateOptions.title}</title> <!-- The title tag shows in email notifications, like Android 4.4. -->
    ...
    <body width="100%" bgcolor="${templateOptions.bgcolor}" style="margin: 0;">
      ...
      <div style="max-width: 680px; margin: auto;" class="email-container">
        ...
        <table role="presentation" aria-hidden="true" cellspacing="0" cellpadding="0" border="0" align="center"
          ...
          <tr style="display: block; width: 100%; max-width: 614px; padding: 16px 32px;">
            <td>
              <!-- //////////////////// -->
          ...
          <!-- Footer : BEGIN -->
          <tr 
            style="background: ${templateOptions.brandColor};">
            <td
            style="padding: 32px; font-family: sans-serif; font-size: 14px; line-height: 20px; color: ${templateOptions.lightColor}; text-align: center;">
            <!-- //////////////////// -->
            <p>${templateOptions.footerText}<br>
            <!-- //////////////////// -->
            <a href=${templateOptions.siteURL} style="color: ${templateOptions.lightColor}">${templateOptions.brand}</a></p>
            </td>
          <!-- Footer : END -->
          </table>
          <!-- Email Body : END -->
